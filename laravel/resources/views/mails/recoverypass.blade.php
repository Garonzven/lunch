...
<html lang="{{ config('app.locale') }}">
  ...
  <body>
    <nav class="nav navbar-default navbar-fixed-top navContainer--pass">
     <div class="container-fluid">
   <!-- Brand and toggle get grouped for better mobile display -->
       <div class="navbar-header">
         <a class="navbar-brand navContainer__logo navContainer__logo--center" href="#">
           <img class="logo" src="images/logo_horizontal_dark.png" alt="Logo">
         </a>
       </div>
     </div>
   </nav>
   <div class="container ">
     <div class="row">
       <div class="p-50 text-ali">
         <hr class="hr-size">
         <!--nombre aqui-->
         <p style="text-align:left;"class="loginBox__title--welcome">Hi,</p>
         <h4>We received a request to reset your password for you</h4>
         <h4>Luch Time account.</h4>
         <!--Correo garonz aqui-->
         <h4><b style="color:#d32f2f;"></b></h4>
         <br>
