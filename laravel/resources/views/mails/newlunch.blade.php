   ...
   <div style="padding-right: 15px; padding-left: 15px;margin-right: auto; margin-left: auto;">
     <div style="margin-right: -15px;margin-left: -15px;">
       <div style="padding-top:65px; text-align: center;">
         <img style="width: 200px;height: 180px;" src="/images/new_menu.png" alt="logo">
         <br>
         <br>
         <h1 style="color:#d32f2f;"><b>Good News!</b></h1>
         <h4>We have delicious new menu just for you</h4>
         <h4>so, what are you waiting for? you can now choose the</h4>
         <h4>dishes of you preference</h4>
...
<html lang="en">
  ...
  <body>
    <nav class="nav navbar-default navbar-fixed-top navContainer--now">
     <div class="container-fluid">
   Brand and toggle get grouped for better mobile display
       <div class="navbar-header">
         <a class="navbar-brand navContainer__logo navContainer__logo--center" href="#">
           <img class="logo logo-now" src="https://s12.postimg.org/fq5rxqpfx/logo_horizontal_dark.png" alt="Logo">
         </a>
       </div>
     </div>
   </nav>
